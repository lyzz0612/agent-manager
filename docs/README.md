...
- [产品需求](./product/README.md)
  - [v1 功能细节](./product/v1-function-details.md)
- [设计稿与布局约定](./design/README.md)
...
- CLI/Runner 以 **`@lyzz0612/agentops-runner`** 通过 npm 分发；Docker 镜像名为 **`agentops-server`**（tag 区分形态）。
